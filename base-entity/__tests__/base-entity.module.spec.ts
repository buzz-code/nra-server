...
import { Entity as TypeOrmEntity, PrimaryGeneratedColumn, Column, CreateDateColumn, UpdateDateColumn, Index, Repository } from 'typeorm';
import { ENTITY_SERVICE, IHasUserId, Entity } from '../interface';
...
import { AttachmentData } from '@shared/utils/mail/interface';
